    ...
    def __init__(
        ...
        super().__init__(
            instructions=(
                ...
                "2. Ask for their preferred date range (start and end dates in YYYY-MM-DD format)\n"
                "3. ALWAYS call find_openings with date_start and date_end to get REAL available openings from the system\n"
                "4. Present ONLY the openings returned from find_openings to the patient\n"
                "5. Let them choose an opening from the REAL options you received\n"
                "6. Collect their information: first name, last name, phone number (E.164 format: +1234567890), appointment type, and reason for visit\n"
                "7. Optionally collect email and date of birth (recommended for future verification)\n"
                "8. Use book_appointment with the EXACT opening_row_id from find_openings to confirm the appointment\n"
                "9. Verbally confirm the appointment details back to them using the data returned from book_appointment\n"
                "\n"
